...
MiniRocket03PRojectile = Class(SingleBeamProjectile) {
    ...
    BeamName = '/mods/BlackOpsFAF-Merged/effects/emitters/missile_munition_exhaust_beam_02_emit.bp',
...
MiniRocket04PRojectile = Class(SingleBeamProjectile) {
    DestroyOnImpact = false,
    BeamName = '/mods/BlackOpsFAF-Merged/effects/emitters/missile_munition_exhaust_beam_03_emit.bp',
...
ShadowCannonProjectile = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
        '/mods/BlackOpsFAF-Merged/effects/emitters/shadowcannon_polytrail_01_emit.bp',
    },
    PolyTrailOffset = {0,0},
...
Juggfire01 = Class(MultiPolyTrailProjectile) {
    ...
    FxTrails = {
        '/mods/BlackOpsFAF-Merged/effects/emitters/Juggfire01_emit.bp',
...
NapalmProjectile01 = Class(EmitterProjectile) {
    FxTrails = {'/mods/BlackOpsFAF-Merged/Effects/Emitters/NapalmTrailFX.bp',},
...
MGQAIRocketChildProjectile = Class(SingleCompositeEmitterProjectile) {
    PolyTrail = '/mods/BlackOpsFAF-Merged/effects/emitters/mgqai_missile_trail_emit.bp',
    BeamName = '/mods/BlackOpsFAF-Merged/effects/emitters/mgqai_missle_exhaust_beam_01_emit.bp',
    PolyTrailOffset = -0.05,
...
MGQAIPlasmaArtyProjectile = Class(EmitterProjectile) {
    ...
    FxImpactLand = {},
    FxImpactUnderWater = {},
    ChildProjectile = '/mods/BlackOpsFAF-Merged/projectiles/MGQAIPlasmaArtyChild01/MGQAIPlasmaArtyChild01_proj.bp',
...
RaiderCannonProjectile = Class(SinglePolyTrailProjectile) {
    FxTrails = {
        ...
        '/mods/BlackOpsFAF-Merged/effects/emitters/raider_cannon_01_emit.bp',
        '/mods/BlackOpsFAF-Merged/effects/emitters/raider_cannon_02_emit.bp',
    },
...
GargEMPWarheadProjectile = Class(NukeProjectile, SingleBeamProjectile) {
    ...
    OnImpact = function(self, targetType, targetEntity)
        ...
        for i = 0, (blanketSides-1) do
            local blanketX = math.sin(i*blanketAngle)
            local blanketZ = math.cos(i*blanketAngle)
            self:CreateProjectile('/mods/BlackOpsFAF-Merged/effects/entities/EffectEMPAmbient01/EffectEMPAmbient01_proj.bp', blanketX, 0.5, blanketZ, blanketX, 0, blanketZ)
                :SetVelocity(blanketVelocity):SetAcceleration(-0.3)
        end
