...
EmtBpPathAlt = '/mods/BlackOpsFAF-Merged/effects/emitters/'
...
ArtemisCloudFlareEffects01 = {
    '/mods/BlackOpsFAF-Merged/effects/emitters/artemis_warhead_02_emit.bp',
    '/mods/BlackOpsFAF-Merged/effects/emitters/artemis_warhead_04_emit.bp',
}
