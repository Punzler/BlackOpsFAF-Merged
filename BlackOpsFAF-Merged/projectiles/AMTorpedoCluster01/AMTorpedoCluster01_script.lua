...
-----------------------------------------------------------------------------------
local AMTorpedoCluster = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsProjectiles.lua').AMTorpedoCluster
...
AANTorpedoCluster01 = Class(AMTorpedoCluster) {
    ...
    OnEnterWater = function(self)
        ...
        local ChildProjectileBP = '/mods/BlackOpsFAF-Merged/projectiles/AMTorpedoClusterSplit01/AMTorpedoClusterSplit01_proj.bp'
