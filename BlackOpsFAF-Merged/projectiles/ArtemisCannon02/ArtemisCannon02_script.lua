...
-----------------------------------------------------------------------------------
local DummyArtemisCannonProjectile = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsProjectiles.lua').DummyArtemisCannonProjectile
...
ADFReactonCannon01 = Class(DummyArtemisCannonProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/BlackOpsFAF-Merged/projectiles/ArtemisWarhead03/ArtemisWarhead03_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
