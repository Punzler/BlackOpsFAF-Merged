...
-----------------------------------------------------------------------------------
local ArtemisCannonProjectile = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsProjectiles.lua').ArtemisCannonProjectile
...
ADFReactonCannon01 = Class(ArtemisCannonProjectile) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
            ...
            nukeProjectile = self:CreateProjectile('/mods/BlackOpsFAF-Merged/effects/entities/ArtemisBombEffectController01/ArtemisBombEffectController01_proj.bp', 0, 0, 0, 0, 0, 0):SetCollision(false)
    ...
    DoTakeDamage = function(self, instigator, amount, vector, damageType)
        if self.ProjectileDamaged then
            ...
            nukeProjectile = self:CreateProjectile('/mods/BlackOpsFAF-Merged/projectiles/ArtemisWarhead02/ArtemisWarhead02_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
            nukeProjectile:PassData(self.Data)
        end
