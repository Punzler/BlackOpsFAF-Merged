...
ArtemisWarhead02 = Class(NullShell) {
    ...
    NormalEffects = {'/mods/BlackOpsFAF-Merged/effects/emitters/artemis_warhead_01_emit.bp',},
    ...
    InnerCloudFlares = function(self, army)
        ...
        CreateEmitterAtEntity(self, army, '/mods/BlackOpsFAF-Merged/effects/emitters/artemis_warhead_ring_01_emit.bp')
    end,

    ---@param self ArtemisWarhead02
    DistortionField = function(self)
        local proj = self:CreateProjectile('/mods/BlackOpsFAF-Merged/effects/ArtemisWarhead/ArtemisWarheadEffect01_proj.bp')
