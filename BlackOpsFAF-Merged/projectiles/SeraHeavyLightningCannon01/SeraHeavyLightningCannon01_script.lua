...
SDFHeavyQuarnonCannon01 = Class(SHeavyQuarnonCannon) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        ...
        nukeProjectile = self:CreateProjectile('/mods/BlackOpsFAF-Merged/projectiles/SeraHeavyLightningCannonChild01/SeraHeavyLightningCannonChild01_proj.bp', 0, 0, 0, nil, nil, nil)
