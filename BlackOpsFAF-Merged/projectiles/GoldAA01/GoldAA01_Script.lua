...
-----------------------------------------------------------------
local GoldAAProjectile = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsProjectiles.lua').GoldAAProjectile
...
GoldAA = Class(GoldAAProjectile) {
    ...
    SplitThread = function(self)
        ...
        local ChildProjectileBP = '/mods/BlackOpsFAF-Merged/projectiles/GoldAA02/GoldAA02_proj.bp'
