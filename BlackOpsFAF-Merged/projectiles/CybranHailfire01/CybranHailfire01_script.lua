...
local CybranHailfire02Projectile = import('/mods/BlackOpsFAF-Merged/lua/EXBlackOpsprojectiles.lua').CybranHailfire02Projectile
   ...
   OnCreate = function(self)
    ...
    SetTurnRateByDist = function(self)
        ...
        if dist > 0 and dist <= 15 then
            ...
            local ChildProjectileBP = '/mods/BlackOpsFAF-Merged/projectiles/CybranHailfire01child/CybranHailfire01child_proj.bp'
