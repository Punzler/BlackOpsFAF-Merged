...
-------------------------------------------------------------------------------------------------------------------
local SeraHeavyLightningCannonChildProjectile = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsProjectiles.lua').SeraHeavyLightningCannonChildProjectile
...
SeraHeavyLightningCannonChild01 = Class(SeraHeavyLightningCannonChildProjectile) {
    AttackBeams = {'/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_lightning_beam_02_emit.bp'},
    FxBeam = {'/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_lightning_beam_02_emit.bp'},
    FxBeamScale = 0.01,
