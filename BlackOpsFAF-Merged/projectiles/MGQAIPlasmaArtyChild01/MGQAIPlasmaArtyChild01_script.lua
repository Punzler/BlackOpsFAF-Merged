...
local MGQAIPlasmaArtyChildProjectile = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsProjectiles.lua').MGQAIPlasmaArtyChildProjectile

---@class MGQAIPlasmaArtyChild01 : MGQAIPlasmaArtyChildProjectile
