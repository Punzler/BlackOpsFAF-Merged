...
local WeaponsFile = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua')
...
BAL0401 = Class(AWalkingLandUnit) {
    ChargeEffects01 = {
        '/mods/BlackOpsFAF-Merged/effects/emitters/g_laser_flash_01_emit.bp',
        '/mods/BlackOpsFAF-Merged/effects/emitters/g_laser_muzzle_01_emit.bp',
    },

    ChargeEffects02 = {
        '/mods/BlackOpsFAF-Merged/effects/emitters/g_laser_charge_01_emit.bp',
    },
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Spinner_Rack', army, '/mods/BlackOpsFAF-Merged/effects/emitters/inqu_glow_effect03.bp'):ScaleEmitter(0.7):OffsetEmitter(0, -2.1, 0))
        table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Spinner_Rack', army, '/mods/BlackOpsFAF-Merged/effects/emitters/inqu_glow_effect01.bp'):ScaleEmitter(3):OffsetEmitter(0, 0, 0))
        table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Spinner_Rack', army, '/mods/BlackOpsFAF-Merged/effects/emitters/inqu_glow_effect02.bp'):ScaleEmitter(3):OffsetEmitter(0, 0, 0))
    end,
    ...
    DeathThread = function(self, overkillRatio)
        ...
        self:CreateProjectileAtBone('/mods/BlackOpsFAF-Merged/effects/entities/InqDeathEffectController01/InqDeathEffectController01_proj.bp', 'Body'):SetCollision(false)
