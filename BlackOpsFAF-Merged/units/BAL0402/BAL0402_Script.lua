...
BAL0402 = Class(AHoverLandUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Maelstrom', army, '/mods/BlackOpsFAF-Merged/effects/emitters/genmaelstrom_aura_01_emit.bp'):ScaleEmitter(1):OffsetEmitter(0, -2, 0))
        table.insert(self.MaelstromEffects01, CreateAttachedEmitter(self, 'Maelstrom', army, '/mods/BlackOpsFAF-Merged/effects/emitters/genmaelstrom_aura_02_emit.bp'):ScaleEmitter(1):OffsetEmitter(0, -2.75, 0))
