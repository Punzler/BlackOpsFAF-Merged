...
BSS0306 = Class(SSeaUnit) {
    ...
    OnStopBeingBuilt = function(self,builder,layer)
        ...
        CreateAttachedEmitter(self, 'Orb', self:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/orbeffect_01.bp'):ScaleEmitter(2)
    end,
