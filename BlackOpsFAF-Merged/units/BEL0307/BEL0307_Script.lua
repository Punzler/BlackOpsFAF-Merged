...
local RailGunWeapon01 = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua').RailGunWeapon01
local TIFCruiseMissileUnpackingLauncher = import('/lua/terranweapons.lua').TIFCruiseMissileUnpackingLauncher
local JuggLaserweapon = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua').JuggLaserweapon
local JuggPlasmaGatlingCannonWeapon = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua').JuggPlasmaGatlingCannonWeapon
