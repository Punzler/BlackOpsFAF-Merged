...
local weaponfile2 = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua')
...
BRA0409 = Class(AirTransport) {
    ...
    MovementAmbientExhaustThread = function(self)
        while not self.Dead do
            ...
            local ExhaustBeamLarge = '/mods/BlackOpsFAF-Merged/effects/emitters/missile_exhaust_fire_beam_10_emit.bp'
