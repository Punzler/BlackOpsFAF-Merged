...
local RailGunWeapon02 = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua').RailGunWeapon02
local CitadelHVMWeapon = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua').CitadelHVMWeapon
local CitadelPlasmaGatlingCannonWeapon = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua').CitadelPlasmaGatlingCannonWeapon
