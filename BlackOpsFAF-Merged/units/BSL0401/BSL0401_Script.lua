...
local AirDroneCarrier = import('/mods/BlackOpsFAF-Merged/lua/BlackOpsunits.lua').AirDroneCarrier
local WeaponsFile = import ('/lua/seraphimweapons.lua')
local WeaponsFile2 = import ('/mods/BlackOpsFAF-Merged/lua/BlackOpsWeapons.lua')
    ...
    Weapons = {
        EyeWeapon01 = Class(YenzothaExperimentalLaser) {
            OnWeaponFired = function(self)
                ...
                table.insert(self.unit.BeamChargeEffects1, AttachBeamEntityToEntity(self.unit, 'Focus_Beam01_Emitter01', self.unit, 'Focus_Beam01_Emitter02', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                ...
                table.insert(self.unit.BeamChargeEffects1, AttachBeamEntityToEntity(self.unit, 'Focus_Beam01_Emitter02', self.unit, 'Focus_Beam01_Emitter03', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
                ...
                table.insert(self.unit.BeamChargeEffects1, AttachBeamEntityToEntity(self.unit, 'Focus_Beam01_Emitter03', self.unit, 'Beam_Point_Focus01', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
        ...
        EyeWeapon02 = Class(YenzothaExperimentalLaser) {
            OnWeaponFired = function(self)
                ...
                table.insert(self.unit.BeamChargeEffects2, AttachBeamEntityToEntity(self.unit, 'Focus_Beam02_Emitter01', self.unit, 'Focus_Beam02_Emitter02', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
                ...
                table.insert(self.unit.BeamChargeEffects2, AttachBeamEntityToEntity(self.unit, 'Focus_Beam02_Emitter02', self.unit, 'Focus_Beam02_Emitter03', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
                ...
                table.insert(self.unit.BeamChargeEffects2, AttachBeamEntityToEntity(self.unit, 'Focus_Beam02_Emitter03', self.unit, 'Beam_Point_Focus02', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
        ...
        EyeWeapon03 = Class(YenzothaExperimentalLaser) {
            OnWeaponFired = function(self)
                ...
                table.insert(self.unit.BeamChargeEffects3, AttachBeamEntityToEntity(self.unit, 'Focus_Beam03_Emitter01', self.unit, 'Focus_Beam03_Emitter02', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
                ...
                table.insert(self.unit.BeamChargeEffects3, AttachBeamEntityToEntity(self.unit, 'Focus_Beam03_Emitter02', self.unit, 'Focus_Beam03_Emitter03', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
                ...
                table.insert(self.unit.BeamChargeEffects3, AttachBeamEntityToEntity(self.unit, 'Focus_Beam03_Emitter03', self.unit, 'Beam_Point_Focus03', self.unit:GetArmy(), '/mods/BlackOpsFAF-Merged/effects/emitters/seraphim_expirimental_laser_charge_beam_emit.bp'))
                for k, v in self.unit.ChargeEffects01 do
